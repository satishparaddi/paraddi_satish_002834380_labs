...
public class BrowseProductsJPanel extends javax.swing.JPanel {
    ...
    private void btnProductDetailsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProductDetailsActionPerformed
        ...
        userProcessContainer.add("ViewProductDetailJPanel1", vp);
        CardLayout layout = (CardLayout)userProcessContainer.getLayout();
    ...
    private void btnCheckOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckOutActionPerformed
        ...
        if(currentOrder.getOrderItemList().isEmpty()){
            JOptionPane.showMessageDialog(null, "Please check Cart is empty", "Info", JOptionPane.WARNING_MESSAGE);
             return;
        }
        ...
        JOptionPane.showMessageDialog(null, "Order Complete! thanks", "Info", JOptionPane.INFORMATION_MESSAGE);
    }//GEN-LAST:event_btnCheckOutActionPerformed

    private void btnModifyQuantityActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModifyQuantityActionPerformed
        int selectedRow = tblCart.getSelectedRow();
        if(selectedRow<0){
            JOptionPane.showMessageDialog(null, "Please select a orderItem from the table first", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        if(item.getProduct().getQuantity()+oldQuant< quantity){
            JOptionPane.showMessageDialog(null, "Please check product availability", "Info", JOptionPane.WARNING_MESSAGE);
            return;
        }
        item.getProduct().setQuantity(item.getProduct().getQuantity()+oldQuant-quantity);
    ...
    private void btnRemoveOrderItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveOrderItemActionPerformed
        ...
        int oldQuant = item.getQuantity();
        item.getProduct().setQuantity(item.getProduct().getQuantity()+oldQuant);
        item.setQuantity(quantity);
    ...
    private void btnViewOrderItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewOrderItemActionPerformed
        ...
        OrderItem item = (OrderItem) tblCart.getValueAt(selectedRow, 0);
        ViewOrderItemDetailJPanel vo = new ViewOrderItemDetailJPanel(userProcessContainer, item);
    ...
    private void btnAddToCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddToCartActionPerformed
        ...
        if(salesPrice < product.getPrice()){
            JOptionPane.showMessageDialog(null, "Sales Price should be more than it is set in the price", "Info", JOptionPane.WARNING_MESSAGE);
            return;
        }
    ...
    private void populateCartTable() {
        ...
        for (OrderItem o : currentOrder.getOrderItemList()) {
            Object row[] = new Object[4];
            row[0] = o;
            row[1] = o.getSalesPrice();
            row[2] = o.getQuantity();
            row[3] = o.getQuantity()*o.getSalesPrice();
            model.addRow(row);
        }
    }
    
    private void populateProductTable(String key) {
        
        DefaultTableModel model = (DefaultTableModel) tblProductCatalog.getModel();
        model.setRowCount(0);
        for(Supplier s : supplierDirectory.getSupplierlist()){
            for (Product p : s.getProductCatalog().getProductcatalog()) {
                if(p.getProdName().equalsIgnoreCase(key)){
                    Object row[] = new Object[4];
                    row[0] = p;
                    row[1] = p.getModelNumber();
                    row[2] = p.getPrice();
